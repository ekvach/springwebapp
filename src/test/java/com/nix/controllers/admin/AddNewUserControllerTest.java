...
@WebAppConfiguration
public class AddNewUserControllerTest {
	...
	@InjectMocks
	private AddNewUserController addNewUserControllerMock;
	...
	public void setup() throws Exception {
		...
		mockMvc = MockMvcBuilders.standaloneSetup(addNewUserControllerMock).build();
	...
	public void applicationContextLoadingTest() {
		...
		Assert.assertNotNull(wac.getBean("addNewUserController"));
	}

	@Test
	public void getAddNewUserPage() throws Exception {
		this.mockMvc.perform(get("/addnewuser"))
				.andDo(print())
				.andExpect(status().isOk())
				.andExpect(view().name("admin/addnewuserform"));
		
		verify(roleDaoMock).findAll();
	}

	@Test
	public void postAddNewUserPagePositive() throws Exception {

		expectedValidationStubbing(false, false, true);

		this.mockMvc.perform(post("/addnewuser")
				.flashAttr("user", user))
				.andDo(print())
				.andExpect(status().is3xxRedirection())
				.andExpect(redirectedUrl(
						"homepageadmin?isLoginExists=false&isEmailExists=false&isPassTheSame=true"));
	...
	@Test
	public void postAddNewUserPageInvalidUserFields() throws Exception {
	...
	@Test
	public void postAddNewUserPageExistingEmail() throws Exception {
		
		expectedValidationStubbing(false, true, true);
	...
	@Test
	public void postAddNewUserPageExistingLogin() throws Exception {
		
		expectedValidationStubbing(true, false, true);
	...
	@Test
	public void postAddNewUserPageDifferentPass() throws Exception {
		
		expectedValidationStubbing(false, false, false);
