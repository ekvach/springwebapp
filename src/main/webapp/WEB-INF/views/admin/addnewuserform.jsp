...
<div class="container mt-5">
    ...
    <form:form action="addnewuser" method="post" modelAttribute="user"
        ...
        <div class="form-group">
            <form:label class="control-label col-sm-2"
                        path="birthday">Birthday</form:label>
            <div class="col-sm-10">
                <form:input type="date" class="form-control"
                            placeholder="Enter Birthday" path="birthday"
                            required="true"/>
        ...
        <div class="form-group">
            <form:label class="control-label col-sm-2"
                        path="userRole.name">Role</form:label>
            <div class="col-sm-10">
                <form:select name="role" class="form-control"
                             path="userRole.name"
                             required="true">
        ...
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10" style="display: inline">
                ...
                <div style="display: inline-block">
                    <a class="btn btn-danger" href="homepageadmin"
